...
if vim.g.vscode then
  ...
  vim.keymap.set('n', 'k', moveCursor('up'), { expr = false })
  vim.keymap.set('n', 'j', moveCursor('down'), { expr = false })
  ...
  vim.keymap.set('v', 'k', moveCursor('up', true), { expr = false })
  vim.keymap.set('v', 'j', moveCursor('down', true), { expr = false })
